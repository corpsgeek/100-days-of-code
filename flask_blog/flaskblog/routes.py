...
def home():
    ...
    posts = Posts.query.order_by(Posts.dateposted.desc()).paginate(page = page, per_page = 5)
...
def user_post(username):
    ...
    posts = Posts.query.filter_by(author=user).order_by(Posts.dateposted.desc()).paginate(page = page, per_page = 5)
